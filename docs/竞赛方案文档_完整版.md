...
> 本项目在开发过程中使用了以下开源项目和 AI 工具。根据第十五届中国软件杯赛题要求，在此显著位置标注所有开源框架的名称、来源及相关许可协议。

---

## C.1 科大讯飞相关工具（赛题规定优先使用）

| 工具/平台 | 用途 | 说明 |
|-----------|------|------|
| **讯飞星火大模型 Spark Pro/4.0Ultra** | 核心 LLM 引擎（首选，优先于其他模型） | 科大讯飞开放平台提供，需注册申请 API Key。系统将 `SPARK_API_KEY` 检测优先级置于第一位，符合赛题"使用科大讯飞相关工具"的要求。接口文档：https://www.xfyun.cn/doc/spark |
| **iFlyCode（科大讯飞 AI 编程助手）** | 部分代码辅助生成 | 用于部分模块的代码辅助生成，各 Agent 文件头部均有标注"AI 辅助编码工具：科大讯飞 iFlyCode / 星火大模型辅助生成" |
...
| 框架/库 | 版本 | 许可协议 | 来源 | 用途 |
|---------|------|----------|------|------|
| **LangGraph** | ≥0.2.0 | MIT License | https://github.com/langchain-ai/langgraph | 有向图驱动的多 Agent 协同编排框架 |
| **LangChain Core** | ≥0.3.0 | MIT License | https://github.com/langchain-ai/langchain | Agent 基础接口、消息格式 |
| **langchain-text-splitters** | ≥0.3.0 | MIT License | https://github.com/langchain-ai/langchain | Markdown 感知的文档切分 |
...
| 工具 | 版本 | 许可协议 | 来源 | 用途 |
|------|------|----------|------|------|
| **Elasticsearch** | ≥8.17.0 | Elastic License 2.0 (ELv2) | https://github.com/elastic/elasticsearch | 混合检索（BM25 + HNSW + RRF）知识库 |
| **elasticsearch-py** | ≥8.17.0 | Apache License 2.0 | https://github.com/elastic/elasticsearch-py | Python 客户端 |
| **Milvus** | ≥2.3.0 | Apache License 2.0 | https://github.com/milvus-io/milvus | 稠密向量语义检索（视频时间戳索引） |
...
| 工具 | 版本 | 许可协议 | 来源 | 用途 |
|------|------|----------|------|------|
| **Neo4j** | ≥5.20.0 | GNU General Public License v3 (Community Edition) | https://github.com/neo4j/neo4j | 知识图谱存储（课程节点 + 依赖关系） |
| **neo4j Python Driver** | ≥5.20.0 | Apache License 2.0 | https://github.com/neo4j/neo4j-python-driver | Python 驱动 |
...
| 工具 | 版本 | 许可协议 | 来源 | 用途 |
|------|------|----------|------|------|
| **FastAPI** | ≥0.115.0 | MIT License | https://github.com/tiangolo/fastapi | HTTP API 框架 |
| **Starlette** | ≥0.36.0 | BSD 3-Clause | https://github.com/encode/starlette | ASGI 底层 |
| **sse-starlette** | ≥1.8.0 | MIT License | https://github.com/sysid/sse-starlette | Server-Sent Events 流式输出 |
| **Pydantic v2** | ≥2.0.0 | MIT License | https://github.com/pydantic/pydantic | 数据校验与序列化 |
| **SQLAlchemy** | ≥2.0.0 | MIT License | https://github.com/sqlalchemy/sqlalchemy | 异步 ORM |
| **uvicorn** | ≥0.30.0 | BSD 3-Clause | https://github.com/encode/uvicorn | ASGI 服务器 |
| **argon2-cffi** | ≥21.0.0 | MIT License | https://github.com/hynek/argon2-cffi | 密码哈希（用户安全） |
...
| 工具 | 版本 | 许可协议 | 来源 | 用途 |
|------|------|----------|------|------|
| **sentence-transformers** | ≥2.2.0 | Apache License 2.0 | https://github.com/UKPLab/sentence-transformers | 语义嵌入（混合检索向量化） |
| **numpy** | ≥1.24.0 | BSD License | https://github.com/numpy/numpy | 数值计算 |
...
| 工具 | 版本 | 许可协议 | 来源 | 用途 |
|------|------|----------|------|------|
| **Vue 3** | ≥3.4.0 | MIT License | https://github.com/vuejs/core | 前端 UI 框架 |
| **Vite** | ≥5.0.0 | MIT License | https://github.com/vitejs/vite | 前端构建工具 |
| **Tailwind CSS** | ≥3.4.0 | MIT License | https://github.com/tailwindlabs/tailwindcss | 原子化 CSS |
| **marked** | ≥12.0.0 | MIT License | https://github.com/markedjs/marked | Markdown 渲染 |
| **mermaid** | ≥11.0.0 | MIT License | https://github.com/mermaid-js/mermaid | 流程图/思维导图渲染 |

---

## C.8 声明

- 以上所有开源组件均遵循其对应许可协议使用，未做侵权修改。
- 科大讯飞相关工具（星火大模型 Spark、iFlyCode）作为本系统的**首选 AI 工具**，符合第十五届中国软件杯赛题"使用科大讯飞相关工具"的明确要求。
- 系统在使用多模态资源生成时，视频类资源目前以**教学视频脚本**形式生成（segments JSON + narration），由前端提供可视化展示，符合赛题要求的"多模态教学内容"范畴；实际视频文件的生成（如接入 SeeDance 等多模态生成模型）可在后续版本中扩展。
