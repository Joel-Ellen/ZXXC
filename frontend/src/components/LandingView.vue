      ...
      <div class="mx-auto flex h-14 max-w-7xl items-center justify-between px-6">
        ...
        <div class="flex items-center gap-3">
          ...
          <button
            v-else
            type="button"
            class="focus-ring hidden rounded-full border border-error/30 bg-error/10 px-4 py-1.5 text-xs font-semibold text-error transition-all duration-200 hover:bg-error/20 hover:border-error/50 md:inline-flex"
            @click="handleLogout"
          >
            退出登录
          </button>
...
const emit = defineEmits(["enter", "logout"]);
